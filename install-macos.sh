...
# ==============================================================================
#  AutoJurnal - Native App Installer for macOS (Apple Silicon & Intel Mac)
# ==============================================================================
...
echo ""
echo "======================================================"
echo "   🍏 Memulai Instalasi AutoJurnal untuk macOS         "
echo "======================================================"
echo ""
...
# 5. Build Native App untuk macOS
echo ""
echo "🖥️  5/5 Membangun Aplikasi Desktop Native AutoJurnal.app..."
chmod +x run.sh stop.sh install.sh scripts/*.sh 2>/dev/null || true
...
if [ -f "scripts/build_universal_app.sh" ]; then
    ...
    echo ""
    echo "   ✅ AutoJurnal.app berhasil dibangun di folder project!"
    echo "   💡 Anda bisa langsung drag/copy 'AutoJurnal.app' ke folder /Applications atau Desktop."
fi

echo ""
echo "======================================================"
echo "   🎉 Instalasi macOS Selesai & AutoJurnal Siap!     "
echo "======================================================"
echo ""
echo "Cara menjalankan AutoJurnal di Mac:"
echo "  1. Klik ganda (Double-click) file 'AutoJurnal.app' di Finder"
echo "     (Aplikasi akan terbuka otomatis di window native)"
echo "  2. ATAU jalankan via terminal: ./run-macos.sh"
echo ""
echo "Untuk menghentikan server:"
echo "  • Jalankan: ./stop-macos.sh (atau pilih 'Hentikan Server' dari AutoJurnal.app)"
echo ""
