...
echo ======================================================
echo    🪟 Memulai Instalasi AutoJurnal untuk Windows
echo ======================================================
echo.
...
echo.
echo ======================================================
echo    🎉 Instalasi Windows Selesai! AutoJurnal Siap
echo ======================================================
echo.
echo Cara menjalankan AutoJurnal:
echo   1. Double-click icon shortcut 'AutoJurnal' di Desktop Anda
echo   2. ATAU double-click file 'run-windows.bat' di folder ini
echo.
echo Untuk menghentikan aplikasi:
echo   - Double-click 'stop-windows.bat'
echo.
pause
